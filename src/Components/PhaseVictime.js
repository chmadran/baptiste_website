import './PhaseVictime.css'

const PhaseVictime = () => {
  return (
    <div className="victime-container">
        <div className="victime-title-section">
          <h2>Vous avez été victime d'une infraction ?</h2>
          <h2>Maître Baptiste Grimaud vous assiste à tous les stades de la procédure.</h2>
        </div>
          <div className="victime-text-section">
